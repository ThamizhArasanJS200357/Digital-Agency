         ...
         <div class="w-full  lg:w-5/12">
            <div class="hero-content">
                <motion.div variants={{
                  ...
                  <h1
                    class="text-transparent bg-clip-text bg-gradient-to-r sm:text-8xl text-2xl from-red-400 to-emerald-600 mb-3  sm:text-[42px] lg:text-[40px] xl:text-5xl"
                    >
                    Here you can <br />
                 ...
                 <p
                    class="mb-8 max-w-[480px] sm:text-base text-body-color text-sm"
                    >
                ...
                <ul class="flex flex-wrap items-center">
                  <li>
                     <Link
                        to="#"
                        class="bg-blue-400 inline-flex items-center justify-center px-6 py-3 text-base font-normal text-center text-white rounded-md bg-primary hover:bg-blue-500 sm:px-10 lg:px-7 xl:px-10"
                        >
                     Get Started
                     </Link>
                  </li>
                  <li>
                     <Link
                        to="#"
                        class="bg-blue-200/80 ml-6 inline-flex items-center justify-center px-6 py-3 text-black font-normal text-center  rounded-md bg-primary hover:bg-blue-200 sm:px-10 lg:px-7 xl:px-10"
                        >
                        Take a Look
                     </Link>
                  </li>
              ...
              transition={{duration:2.4, delay:0.25}}
               class="relative z-10 inline-block pt-11 lg:pt-0 mt-6">
                  <img
                     ...
                     src={Stars} 
                     alt="stars" 
                     className='z-10 w-28 absolute mt-[-105%] right-[-5%] opacity-70 hover:opacity-100' 
                     />

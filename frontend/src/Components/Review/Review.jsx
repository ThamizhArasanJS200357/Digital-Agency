    ...
    <div className='overflow-x-hidden max-w-screen font-poppins'>
		...
		<div className="grid items-center gap-4 xl:grid-cols-5">
			<div className="max-w-2xl mx-auto rounded shadow-md bg-blue-100/10 p-6 my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
				...
				<p className="text-black">Here are some reviews of our costumers and their excperience
                with our services and that wee provide!</p>
			</div>
						...
						<div className="p-6 rounded shadow-md bg-blue-200/30">
                          ...
                          exceptional customer care.</p>
							<div className="flex items-center mt-4 space-x-4">
                                ...
                                <div className='flex'>
                                <MdVerified size={Width < 631 ?30:40} className='text-green-400 ml-2'/>
                                </div>
							</div>
						</div>
                          ...
                          the future.</p>
							<div className="flex items-center mt-4 space-x-4">
								...
								<div>
									...
									<p className="text-sm dark:text-gray-600">Microsoft</p>
								</div>
                                <div className='flex'>
                                <MdVerified size={Width < 631 ?30:40}className='text-green-400 ml-2'/>
                                </div>
                          ...
                          the future.</p>
							<div className="flex justify-between  items-center mt-4 space-x-4">
								...
								<div className='flex-col sm:ml-2'>
									<p className="text-lg font-semibold">Benjamin Mitchell</p>
									<p className="text-sm dark:text-gray-600">Razer</p>
								</div>
                                </div>

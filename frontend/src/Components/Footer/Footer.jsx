    ...
    <div className='overflow-x-hidden max-w-screen font-poppins'>
        ...
        <div className='sm:flex justify-between py-10 px-8 grid bg-gray-900'>
            <div className='text-white'>
                ...
                <p className='py-4'>Welcome to LevelUp Solutions, where we transform raw information
            ...
            <div className='text-white sm:w-[900px] sm:ml-[18%] sm:mr-[12%] sm:pt-0 '>
                ...
                <div className='my-4'>
                    <div className='justify-center flex'>
                        <input className='placeholder:pl-2 flex mr-[-50px] h-10 sm:w-[50%] sm:h-[35px] mx-auto rounded-md text-black  '
                        type='email'
                        placeholder='Enter Your E-mail'/>
                        <button className='bg-blue-400 mx-auto w-20 hover:bg-blue-500 rounded-md font-medium'>Sign Up</button>
                    </div>

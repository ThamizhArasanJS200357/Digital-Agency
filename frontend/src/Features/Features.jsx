  ...
  return (
	...
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		<div>
			...
			<p className="max-w-3xl mx-auto mt-4 text-xl text-center dark:text-gray-600">Growth Through Advanced Technology Solutions, Analytics and Professionaly Trained Personnel</p>
		</div>
		<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
			<div>
				<h3 className="text-2xl font-bold tracking-tight sm:text-3xl ">Inovation Begins Here</h3>
				<p className="mt-3 text-lg dark:text-gray-600">Unleash business growth with advanced technology solutions, optimizing operations, integrating innovative technologies, and receiving personalized support..</p>
				<div className="mt-12 space-y-12">
                    ...
                    className="flex">
						...
						<div className="ml-4">
                            ...
                            Advanced Algorithmic Solutions</h4>
							<p className="mt-2 dark:text-gray-600">Our advanced algorithms optimize your operations, boosting efficiency and profitability. Make data-driven decisions with actionable insights.</p>
						</div>
					</div>
					<div 
                    className="flex">
						...
						<div className="ml-4">
							<h4 className="text-lg font-medium leading-6 ">Innovative Technology Integration</h4>
							<p className="mt-2 dark:text-gray-600">Seamlessly integrate cutting-edge technologies like AI, IoT, and cloud computing. Automate tasks, improve communication, and unlock growth potential.</p>
						</div>
					</div>
					<div
                    className="flex">
						...
						<div className="ml-4">
							<h4 className="text-lg font-medium leading-6 ">Trained Personnel Support</h4>
							<p className="mt-2 dark:text-gray-600">Our trained experts ensure smooth implementation and ongoing guidance. Leverage our software effectively with personalized assistance.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div>
			<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
				<div className="lg:col-start-2">
					<h3 className="text-2xl font-bold tracking-tight sm:text-3xl ">Data-Driven Decisions, Personalized Solutions</h3>
					<p className="mt-3 text-lg dark:text-gray-600">Data-driven decisions. Personalized solutions. Continuous innovation. Propel your business forward with our powerful analytics, tailored to your needs, and future-proofed by our commitment to innovation.</p>
					<div className="mt-12 space-y-12">
						<div
                        ...
                        className="flex">
							...
							<div className="ml-4">
								...
								<p className="mt-2 dark:text-gray-600">Extract valuable insights from your data with comprehensive visualizations. Monitor KPIs, track trends, and identify areas for improvement.</p>
							</div>
						</div>
						<div
                        className="flex">
